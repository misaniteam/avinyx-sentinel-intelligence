...
from routers import campaigns_router, voters_router, media_feeds_router, topic_keywords_router
...
app.include_router(topic_keywords_router, prefix="/campaigns/topic-keywords", tags=["topic-keywords"])
